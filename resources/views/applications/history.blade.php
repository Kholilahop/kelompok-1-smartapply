                ...
                <tbody>
                    @foreach($applications as $app)
                        <tr>
                            ...
                            <td>
                                <button onclick="showCoverLetter('{{ addslashes($app->cover_letter) }}')" class="btn btn-info btn-sm">
                                    Lihat Surat
                                </button>
                            </td>
                        </tr>
...
<!-- Modal -->
<div id="coverLetterModal" class="modal fade" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <pre id="coverLetterContent" class="p-3 bg-light" style="white-space: pre-wrap; max-height: 400px; overflow-y: auto;"></pre>
            </div>
        </div>
    </div>
</div>
